...
const { sys_status, cpu_info, memory_info, disk_info, os_info, network_info, process_info} = require('../controllers/check_status');
...
router.post('/network', check_service('network'), validate_api_key, network_info);
router.post('/process', check_service('process'), validate_api_key, process_info);
